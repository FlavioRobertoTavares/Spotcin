...
Scenario: Uptade de uma playlist
    ...
    When uma requisição PUT for enviada para "/api/playlists/42/20" com o corpo da requisição sendo um JSON com o nome "Músicas gospels"
    Then o status da resposta deve ser "200"
...
Scenario: Delete de uma playlist
    ...
    When uma requisição DELETE for enviada para "/api/playlists/42/20"
    Then o status da resposta deve ser "200"
...
Scenario: Adicionar uma música a uma playlist
    Given que o PlaylistRepository tem uma playlist com id "42" e nome "Músicas de madrugada"
    When uma requisição POST for enviada para "/api/playlists/42/songs/fur elise/20"
    Then o status da resposta deve ser "200"
...
Scenario: Deletar uma música de uma playlist
    Given que o PlaylistRepository tem uma playlist com id "42", nome "Músicas de madrugada" e música "fur elise"
    When uma requisição DELETE for enviada para "/api/playlists/42/songs/fur elise/20"
    Then o status da resposta deve ser "200"
